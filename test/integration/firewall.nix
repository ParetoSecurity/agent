...
in {
  ...
  testScript = ''
    ...
    out = wideopen.fail("paretosecurity check --only 2e46c89a-5461-4865-a92e-3b799c12034a --verbose")
    expected = (
        "  • Starting checks...\n"
    ...
    out = walled.succeed("paretosecurity check --only 2e46c89a-5461-4865-a92e-3b799c12034a --verbose")
    expected = (
        "  • Starting checks...\n"
